...
let db = {
  ...
  orders: [
    {
      id: 'o1', harvestId: 'h1', farmerId: 'f1', farmerName: 'Ramesh Patil',
      retailerId: 'r1', retailerName: 'City Fresh Mart',
      crop: 'Tomatoes', quantity: 100, pricePerUnit: 25, totalAmount: 2500,
      status: 'confirmed', paymentStatus: 'paid', upiRef: 'TXN1001',
    ...
    {
      id: 'o2', harvestId: 'h3', farmerId: 'f2', farmerName: 'Sunita Desai',
      retailerId: 'r1', retailerName: 'City Fresh Mart',
    ...
    {
      id: 'o3', harvestId: 'h2', farmerId: 'f1', farmerName: 'Ramesh Patil',
...
app.post('/api/harvests', authMiddleware, (req, res) => {
  ...
  const harvest = {
    ...
    crop, quantity: parseFloat(quantity),
    pricePerUnit: parseFloat(pricePerUnit),
    availableFrom, description: description || '',
    image: cropEmojis[crop] || '🌾',
    photo: photo || null,
    lat: lat || user.lat || 16.4088,
    lng: lng || user.lng || 74.3830,
...
app.delete('/api/harvests/:id', authMiddleware, (req, res) => {
  ...
  // Check if there are pending orders for this harvest
...
app.post('/api/orders', authMiddleware, (req, res) => {
  ...
  const totalAmount = qty * harvest.pricePerUnit;
...
app.patch('/api/orders/:id/status', authMiddleware, (req, res) => {
  ...
  // Allow explicit paymentStatus update (e.g. from UPI confirmation)
